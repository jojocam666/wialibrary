#if a transaction as been relayed a sufficient number of times on the network between the nodes, it's confirmed
...
#if the tx_confirms_n >= 5% of the total nodes on the blockchain,the tx is valid and
