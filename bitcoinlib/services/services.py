...
from wialib import services
from wialib.networks import Network
from wialib.encoding import to_bytes, int_to_varbyteint, varstr, varbyteint_to_int
from wialib.db_cache import *
from wialib.transactions import Transaction, transaction_update_spents
from wialib.blocks import Block
...
class Service(object):
    ...
    def __init__(self, network=DEFAULT_NETWORK, min_providers=1, max_providers=1, providers=None,
        ...
        fn = Path(WIL_DATA_DIR, 'providers.json')
        f = fn.open("r")
